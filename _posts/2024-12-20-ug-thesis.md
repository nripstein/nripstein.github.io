...
description: My journey towards automating 250 hours of manual video labelling for my undergrad thesis lab and boosting my team's productivity. <br><br>(And don't worry, there's a 1 minute TLDR overview)
...
<ol>
    <li>
        ...
        <ul>
            <li>Used an image classification model to detect "hand-object contact" frame by frame.</li>
